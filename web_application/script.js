...
let index = 0;
const facts = document.querySelectorAll('.carousel-fact');
...
if (facts.length > 0) {
  facts[0].classList.add('active'); // Show the first fact initially
  setInterval(showNextFact, 3000);  // Change every 3 seconds
}
